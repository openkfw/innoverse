...
export interface ApiCollaborationQuestionCollaborationQuestion
  ...
  attributes: {
    ...
    isPlatformFeedback: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiEmailBaseTemplateEmailBaseTemplate
  ...
  attributes: {
    ...
    footerActivityNote: Schema.Attribute.Text &
      ...
      Schema.Attribute.DefaultTo<'Diese Email wurde aufgrund von Aktivit\u00E4t in InnoVerse gesendet.'>;
    footerAddress: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'InnoVerse'>;
    ...
    footerEmailSettings: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Einstellungen'>;
    footerPrivacy: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Privatsph\u00E4re'>;
    ...
    footerUnsubscribe: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Abbestellen'>;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    author: Schema.Attribute.Relation<'oneToOne', 'api::inno-user.inno-user'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    Themes: Schema.Attribute.Component<'theme.theme', true>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiInnoUserInnoUser extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    collaboration_questions: Schema.Attribute.Relation<
      'manyToMany',
      'api::collaboration-question.collaboration-question'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    projectStart: Schema.Attribute.Date & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Exploration'>;
    summary: Schema.Attribute.Text & Schema.Attribute.Required;
    team: Schema.Attribute.Relation<'oneToMany', 'api::inno-user.inno-user'>;
...
export interface ApiSurveyQuestionSurveyQuestion
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    question: Schema.Attribute.Text & Schema.Attribute.Required;
    responseOptions: Schema.Attribute.Component<
...
export interface ApiUpdateUpdate extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    linkToCollaborationTab: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiWeeklyEmailTemplateWeeklyEmailTemplate
  ...
  attributes: {
    ...
    headerSubtitle: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Dein w\u00F6chentliches Update aus der Innovationsbubble'>;
    headerTitle: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'News aus dem InnoVerse'>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
