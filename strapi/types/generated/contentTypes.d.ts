...
export interface ApiEmailBaseTemplateEmailBaseTemplate
  ...
  attributes: {
    footerActivityNote: Attribute.Text &
      Attribute.Required &
    ...
    footerContactUs: Attribute.String &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    footerPrivacy: Attribute.String &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    footerUnsubscribe: Attribute.Text &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    footerEmailSettings: Attribute.String &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    footerSmallLogo: Attribute.Media<'images'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    description: Attribute.Component<'description.description'> &
      Attribute.Required;
    author: Attribute.Relation<
      'api::project.project',
      'oneToOne',
...
export interface ApiSurveyQuestionSurveyQuestion extends Schema.CollectionType {
  ...
  attributes: {
    ...
    responseOptions: Attribute.Component<
