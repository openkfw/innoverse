    ...
    <Grid item xs={4}>
      <Box sx={{ marginBottom: 4, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 1 }}>
        <Box style={{ height: 64, flexShrink: 0 }}>
          {isFirstStep ? (
            <svg xmlns="http://www.w3.org/2000/svg" width="400" height="64" viewBox="0 0 340 64" fill="none">
              <path
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="400" height="64" viewBox="0 0 337 64" fill="none">
              <path
